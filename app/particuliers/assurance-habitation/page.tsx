      ...
      <SiteLayout>
        ...
        <section className="py-24 sm:py-28">
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            {/* H2 → "Une solution pour chaque situation" */}
            ...
            <div className="mt-14 grid gap-6 sm:grid-cols-3 lg:grid-cols-3">
              {/* H3 → repeats per profile: "Propriétaire occupant", "Locataire", "Résidence secondaire" (3 items) */}
        ...
        <section className="bg-surface py-24 sm:py-28">
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            {/* H2 → "Protégé contre tous les aléas du quotidien" */}
            <SectionHeading
              eyebrow="Risques couverts"
              title="Protégé contre tous les aléas du quotidien"
            />
            <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {/* H3 → repeats per risk: "Incendie & explosion", "Dégâts des eaux", "Vol & tentative de vol", "Catastrophes naturelles", "Dommages aux appareils électroménagers", "Dommages aux équipements électriques", "Responsabilité civile - chef de famille", "Bris de glaces et de miroirs", "Relogement et déplacement du mobilier" (9 items) */}
              {RISKS.map((risk) => (
                <div
                  key={risk.title}
        ...
        <section className="relative isolate overflow-hidden bg-navy py-24 text-white sm:py-28">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-5 lg:px-8">
            ...
            {/* H2 → "Un accompagnement de bout en bout" */}
            ...
            <p className="mx-auto mt-5 max-w-2xl text-center leading-relaxed text-white/75">
              En cas de sinistre, vous n'êtes jamais seul. Notre équipe prend en charge
              l'intégralité du processus.
            </p>
            {/* H3 → repeats per step: "Déclaration immédiate", "Expert envoyé en 48h", "Relogement d'urgence", "Indemnisation rapide" (4 items) */}
        ...
        <section className="relative isolate overflow-hidden py-24 sm:py-28">
          ...
          />
          <div className="relative z-10 mx-auto max-w-7xl px-5 lg:px-8">
            {/* H2 → "Ce qui nous guide au quotidien" */}
            <SectionHeading eyebrow="Nos valeurs" title="Ce qui nous guide au quotidien" />
            <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {/* H3 → repeats per value: "Transparence", "Intégrité", "Empathie", "Disponibilité" (4 items) */}
              {VALUES.map((value) => (
                <div
                  key={value.title}
        ...
        {/* H2 → "Garantissez la sécurité de votre domicile" */}
        <FinalCta
