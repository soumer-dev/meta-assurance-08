  ...
  head: () => ({
    meta: [
      { title: "Contact — Meta Assurances et Conseils" },
      {
        name: "description",
        content:
          "Une question, un sinistre, une demande de devis ? Notre équipe de conseillers vous répond rapidement. Assistance 24h/7j.",
      },
      { property: "og:title", content: "Contactez Meta Assurances et Conseils" },
      { property: "og:description", content: "Parlez à un expert. Rappel en moins de 10 minutes." },
      ...
      <section className="py-24 sm:py-28">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="grid gap-6 lg:grid-cols-3">
            {OPTIONS.map(({ icon: Icon, pill, title, desc, cta, href }) => (
              <div
                key={title}
              ...
              >
                ...
                <p className="mt-2 grow text-sm leading-relaxed text-muted-foreground">{desc}</p>
                <a
                  href={href}
      ...
      <section className="bg-surface py-24 sm:py-28">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {COORDONNEES.map(({ icon: Icon, label, value, sub }) => (
              <div key={label} className="rounded-3xl border border-border bg-white p-6 shadow-soft">
